...
import com.wallet.wallet.api.controller.Security.jwt.JwtUtil;
...
public class ExpenseServiceImpl extends GenericServiceImpl<Expense, ExpenseResponseDto, ExpenseRequestDto, Long> implements IExpenseService {
    ...
    public List<ExpenseResponseDto> getAllByUserId(String token) {
        ...
        return expenseMapper.listEntityToListResponseDto(convertExpense(expenseRepository.getAllByUserId(userId), "AR", 1.0));
    }
    ...
    public HomeResponseDto getForHome(String token){
        ...
        Long userId = jwtUtil.extractUserId(token);
        User user = userService.getById(userId);
        String userCodeCurrency = "AR";
        Double userValueCurrency = 1.0;
        ...
        homeResponseDto.setSymbolCurrency("AR");
    ...
    public StatisticsResponseDto getStatistics(String token){
        ...
        if(now.getMonthValue() == 12){
            for(int i=0; i<12; i++){
                ...
                switch (now.minusMonths(i).getMonthValue()){
                    case 1: months.add("enero");
                        break;
                    case 2: months.add("febrero");
                        break;
                    case 3: months.add("marzo");
                        break;
                    case 4: months.add("abril");
                        break;
                    case 5: months.add("mayo");
                        break;
                    case 6: months.add("junio");
                        break;
                    case 7: months.add("julio");
                        break;
                    case 8: months.add("agosto");
                        break;
                    case 9: months.add("septiembre");
                        break;
                    case 10: months.add("octubre");
                        break;
                    case 11: months.add("noviembre");
                        break;
                    case 12: months.add("diciembre");
                        break;
                }
